...
void RenderDevice::ResolveMsaa(OVR::Render::Texture* msaaTex, OVR::Render::Texture* outputTex)
{
    ...
    glBlitFramebuffer( 0, 0, msaaTex->GetWidth(), msaaTex->GetHeight(),
                       outputTex->GetWidth()/4, outputTex->GetHeight()/4, outputTex->GetWidth()/4 + msaaTex->GetWidth(), outputTex->GetHeight()/4 + msaaTex->GetHeight(), GL_COLOR_BUFFER_BIT, GL_NEAREST );
